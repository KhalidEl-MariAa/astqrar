...
final String time;
  AcceptNotification({required this.notificationType,required this.time,required this.clickUser ,required this.userName,required this.gender,required this.userId,required this.message});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  //    "12 Aug , 5:20 Pm",
                      style:
                          GoogleFonts.poppins(color: customGrey, fontSize: 7.sp),
                    )
                ],
              ),
