          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Text("إعادة تسجيل دخول", style: GoogleFonts.almarai(color: PRIMARY, fontSize: 13.sp,  decoration: TextDecoration.underline),),
              ),
              ...
              InkWell(
                ...
                child: Text("مراجعة حالة الحساب", style: GoogleFonts.almarai(color: PRIMARY, fontSize: 13.sp,  decoration: TextDecoration.underline),),
              ),
