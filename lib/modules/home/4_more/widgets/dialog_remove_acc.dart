...
class DialogRemoveAcc extends StatelessWidget 
{
  const DialogRemoveAcc({Key? key}) : super(key: key);
      ...
      builder:(context,state)=> AlertDialog(
        ...
        content: Container(
            ...
            child: Column(
              ...
              children: [
                Padding(
                    padding: EdgeInsetsDirectional.only( top: 4.5.h, start: 1.w, end: 3.w),
                    child: Center(
                  ...
                  children: [
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          margin: EdgeInsetsDirectional.only( start: 2.w, top: 1.h, bottom: 1.h),
                          height: 6.h,
                          width: 35.w,
                          decoration: 
                            BoxDecoration(
