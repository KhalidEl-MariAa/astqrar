                      ...
                      children: [
                          ...
                          child: Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              onChanged: (String? newValue) {
                                setState(() {
                                  newUser.gender =
                                      this.Gender.indexOf(newValue!);
                                });
                              },
                              items: this.Gender.sublist(1).map((String g) {
                        ...
                        Row(
                          children: [
                            ...
                            Text("اوافق علي  ",
                                style:
                                    TextStyle(color: PRIMARY, fontSize: 10.sp)),
                            InkWell(
                        ...
                        if (state is LoginAfterRegisterState)
                          BlocProvider<ShopLoginCubit>(
                            create: (BuildContext context) {
                              ShopLoginCubit mycubit = ShopLoginCubit();
